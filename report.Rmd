...
```{r means, echo = FALSE, fig.cap = "Estimated mean Ct values in (A) unvaccinated patients without any known prior infection, in unvaccinated patients as a function of whether there was knowledge of any prior infection (B), and in patients without any known prior infection as a function of the number of vaccine doses (C). Bands indicate estimated 90% confidence intervals of the means.", fig.width = 12}
...
Indeed we observe higher viral loads during periods of increase than during periods of decrease for all variants (Figure \@ref(fig:time-means)C), and the trajectory of ct values compared to the case trajectories that this can explain differences between predicted and observed ct values.
