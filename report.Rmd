...
date: 27 July, 2021. Preliminary report.
...
The model was implemented using the `brms`  [@brms] package version 2.15.0 in `R` version 4.1.0 [@R] with the `cmdstanr` backend [@cmdstanr]. Default priors from `brms` were used for all parameters. 
<!-- All code required to reproduce this analysis is available from [https://github.com/epiforecasts/covid19_ct_pillar2](https://github.com/epiforecasts/covid19_ct_pillar2).  -->
