...
var_ass <- tibble(
  ...
  Condition = c(
    ...
    "2021-12-01 <= Specimen date AND S-gene negative", 
    "2022-02-02 >= Specimen date AND S-gene positive"
  )
)
...
Modelling viral loads as a function of time since symptom onset, age, evidence of prior infection and number of vaccine doses yields poor predictions at the individual level (deviance explained: `r summary(fit)$dev.expl * 100`%) yet broadly recovers the time-trends in mean viral loads (Figure \@ref(fig:time-means)A-B).
